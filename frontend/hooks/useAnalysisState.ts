...
export const useAnalysisState = create<AnalysisState>((set, get) => ({
  // Initial state
  selectedIssue: null,
  selectedNode: null,
...
export function useIssueSelection() {
  const { selectedIssue, setSelectedIssue } = useAnalysisState()
  return { selectedIssue, setSelectedIssue }
}

export function useNodeSelection() {
  const { selectedNode, setSelectedNode } = useAnalysisState()
  return { selectedNode, setSelectedNode }
}

export function useFileSelection() {
  const { selectedFilePath, setSelectedFilePath } = useAnalysisState()
  return { selectedFilePath, setSelectedFilePath }
}

export function useSymbolSelection() {
  const { selectedSymbolName, setSelectedSymbolName } = useAnalysisState()
...
export function useViewOptions() {
  const { sortBy, viewMode, setSortBy, setViewMode } = useAnalysisState()
