...
# Enhanced Function to get Modal URL from deployment with 5-strategy detection
get_modal_url_auto() {
...
show_menu() {
    ...
    print_color $GREEN "5) 🌐 Backend Modal + Frontend (Enhanced Auto-Detection)"
    echo ""
    ...
    while true; do
        ...
        case $choice in
            ...
            4)
                ...
                ;;
            5)
                print_color $GREEN "🌐 Starting backend modal + frontend with enhanced auto-detection..."
                install_frontend_deps
                run_in_background 5
                ;;
            0)
